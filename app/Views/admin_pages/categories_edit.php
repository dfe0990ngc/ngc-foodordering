	...
	<div class="row justify-content-center">
		...
		<div class="col col-sm-6 col-md-4 col-lg-4">
			<div class="mb-1 form-group input-group-sm">
				...
				<input tabindex="1" type="text" class="form-control" name="name" value="<?= $name;?>"></input>
			...
			<div class="mb-1 form-group input-group-sm">
				...
				<input tabindex="3" type="text" class="form-control" name="description" value="<?= $description;?>"></input>
			...
			<div class="mb-1 form-group input-group-sm">
				...
				<select class="form-control" name="parent" value="<?= $parent;?>">
					<option value="0">--select parent category--</option>
					<?php foreach($PCATEGORIES as $row){ ?>
					<option 
						value="<?= $row['ID']; ?>" 
						<?= intval($row['ID'])==intval($parent)?'selected':'' ?>
						><?= $row['name']; ?>
				 	</option>
					<?php } ?>
				</select>
			...
			<div class="mb-1 form-group input-group-sm">
				...
				<input type="checkbox" name="active" <?= $active=='1'?'checked':'';?>>
				<small class="text-danger"><?= isset($validation)?display_error($validation,"parent"):'' ?></small>
			</div>
		</div>
		<div class="row justify-content-center">
