	...
	<div class="row justify-content-center">
		...
		<div class="col col-sm-6 col-md-4 col-lg-4">
			<div class="mb-1 form-group input-group-sm">
				...
				<input tabindex="1" type="text" class="form-control" name="fname" value="<?= set_value("fname");?>"></input>
			...
			<div class="mb-1 form-group input-group-sm">
				...
				<input tabindex="3" type="text" class="form-control" name="lname" value="<?= set_value("lname");?>"></input>
			...
			<div class="mb-1 form-group input-group-sm">
				...
				<input tabindex="5" type="text" class="form-control" name="username" value="<?= set_value("username");?>" autocomplete="off"></input>
		...
		<div class="col col-sm-6 col-md-4 col-lg-4">
			<div class="mb-1 form-group input-group-sm">
				...
				<input tabindex="2" type="text" class="form-control" name="mname" value="<?= set_value("mname");?>"></input>
			...
			<div class="mb-1 form-group input-group-sm">
				...
				<input tabindex="4" type="text" class="form-control" name="nname" value="<?= set_value("nname");?>"></input>
				<small class="text-danger"><?= isset($validation)?display_error($validation,"nname"):'' ?></small>
			</div>
			<div class="mb-1 form-group input-group-sm">
				<label class="text-muted" for="password">Password</label>
				<input tabindex="6" type="password" class="form-control" name="password" value="<?= set_value("password");?>" autocomplete="off"></input>
